...
#define CONFIG_MAX17048_CUSTOM
	...
	|| defined(CONFIG_MACH_MSM8926_JAGNM_BELL) || defined(CONFIG_MACH_MSM8926_JAGC_SPR) || defined(CONFIG_MACH_MSM8926_JAGN_KR)
enum cell_type{
 LGC_LLL,
 TCD_AAC
};
...
struct max17048_battery_model {
	...
	|| defined(CONFIG_MACH_MSM8926_JAGNM_TLS) || defined(CONFIG_MACH_MSM8926_JAGNM_VTR) || defined(CONFIG_MACH_MSM8926_JAGNM_BELL) \
	|| defined(CONFIG_MACH_MSM8926_JAGC_SPR) || defined(CONFIG_MACH_MSM8926_JAGN_KR)
	int empty;
#endif
#ifdef CONFIG_LGE_PM
	int rcomp;
